...
class RSpecHoneycombFormatter
  RSpec::Core::Formatters.register self, :start, :example_group_started, :example_group_finished, :example_started, :example_passed, :example_failed, :example_pending, :message, :stop, :start_dump
  ...
  def example_group_started(notification)
    ...
    group_span.add_field('rspec.id', 'group')
  ...
  def example_started(notification)
    @example_span = Honeycomb.start_span(name: notification.example.description)
    @example_span.add_field('rspec.id', 'example')
  ...
  def example_failed(notification)
    ...
    @example_span.add_field('rspec.description', notification.example.description)
    @example_span.add_field('rspec.message', notification.colorized_message_lines(RSpec::Core::Notifications::NullColorizer).join("\n"))
